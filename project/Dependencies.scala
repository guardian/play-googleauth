...
object Dependencies {
  ...
  val googleDirectoryAPI = Seq(
    "com.google.apis" % "google-api-services-admin-directory" % "directory_v1-rev20220325-1.32.1",
    "com.google.api-client" % "google-api-client" % "1.35.1", // https://security.snyk.io/vuln/SNYK-JAVA-COMGOOGLEOAUTHCLIENT-2807808
