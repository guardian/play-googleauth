...
```
This version has a dependancy on `cats 0.9.*`. Therefore, (for compatibility) it is advised your project or any of its dependendancies do not depend on `cats 0.7.*` or below.
